---
current_phase: governance-ledger-divergence-cleanup-v1
current_task_id: TASK-GOV-067
...
- `TASK-GOV-067`: `Ledger divergence cleanup and governance regression` is the live coordination task for `governance-ledger-divergence-cleanup-v1`.
## Recently Closed
