---
current_phase: governance-doc-driven-coordination-planner-v1
current_task_id: TASK-GOV-013
...
- `TASK-GOV-013`: `文档驱动协调任务包生成与优先级编排` is the live coordination task for `governance-doc-driven-coordination-planner-v1`.
## Recently Closed
