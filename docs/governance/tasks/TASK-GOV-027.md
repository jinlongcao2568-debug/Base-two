...
- `pytest tests/governance/test_parallel_closeout_pipeline.py tests/governance/test_authority_alignment.py tests/governance/test_task_ops.py -q`
...
- `parallelism_plan_id`: `plan-TASK-GOV-025-3`
- `review_bundle_status`: `not_applicable`
- `reserved_paths`: `src/, docs/contracts/, db/migrations/, tests/integration/, tests/automation/, scripts/task_coordination_lease.py, scripts/task_continuation_ops.py, scripts/task_lifecycle_ops.py, scripts/task_worker_ops.py`
- `branch`: `feat/TASK-GOV-027-child-closeout-mirror`
